...
const MotionCard = ({ children, className = "", onClick }: MotionCardProps) => (
  <motion.div
    variants={fadeInUp}
    onClick={onClick}
    className={`group relative rounded-xl border border-white/10 bg-zinc-900/50 p-4 shadow-2xl shadow-black/40 backdrop-blur-md hover:border-orange-500/20 ${className}`}
  >
